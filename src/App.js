  ...
  async function handleLikeRepository(id) {
    api.post(`/repositories/${id}/like`)
      .then(response => {
        ...
        const likedRepo = { ...repositories[likedRepoIndex], likes };
        const newRepositories = [ ...repositories ];
        newRepositories.splice(likedRepoIndex, 1, likedRepo);
        setRepositories(newRepositories);
      })
      .catch(error => 
        console.error('Problema ao realizar o like do repositório', error))
  }
